<x-app-layout>
    <div class="py-10">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h1 class="text-2xl font-extrabold text-gray-900">Student Record Lookup</h1>
                <p class="text-sm text-gray-500 mt-1">Search student profiles and review their transaction history.</p>
            </div>

            {{-- Search --}}
            <form method="GET" action="{{ route('registrar.students.index') }}"
                ...
                @forelse ($students as $student)
                    <a href="{{ route('registrar.students.show', $student) }}"
                       class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 hover:border-blue-300 hover:shadow-md transition">
                        ...
                        <p class="mt-2 text-xs text-blue-700 font-semibold">View record →</p>
                    </a>
                @empty
