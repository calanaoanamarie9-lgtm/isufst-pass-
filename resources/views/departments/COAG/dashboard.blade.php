            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                    ...
                    <div class="mt-2 flex gap-2">
                        <a href="{{ route('coag.appointments') }}" class="px-3 py-1.5 bg-blue-50 text-blue-700 text-xs font-bold rounded-lg hover:bg-blue-100 transition">Appointments</a>
                        <a href="{{ route('coag.availability') }}" class="px-3 py-1.5 bg-green-50 text-green-700 text-xs font-bold rounded-lg hover:bg-green-100 transition">Availability</a>
                    </div>
                </div>
            </div>
